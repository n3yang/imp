...
{	
	switch (session)
    {
        ...
        case 2:
        case 3:
			$("#left_cat").html(openA+input.catA.label+closeA+'<br>or<br>'+open1+input.cat1.label+close1);
			$("#right_cat").html(openA+input.catB.label+closeA+'<br>or<br>'+open1+input.cat2.label+close1);
            break;
        case 4:
        ...
        case 5:
        case 6:
			$("#left_cat").html(openA+input.catB.label+closeA+'<br>or<br>'+open1+input.cat1.label+close1);
			$("#right_cat").html(openA+input.catA.label+closeA+'<br>or<br>'+open1+input.cat2.label+close1);
            break;
    }
	if (session == 7)
	{
